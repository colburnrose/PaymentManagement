...
namespace PaymentManagement.DataLayer.Migrations
{
    ...
    [Migration("20200207163415_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentManagement.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaymentManagement.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaymentManagement.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaymentManagement.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PaymentManagement.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PaymentManagement.Entity.TaxYear", "TaxYear")
                        .WithMany()
